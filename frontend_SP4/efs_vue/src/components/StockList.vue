                      ...
                      <v-card>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          ...
                          <v-list-item>
                            ...
                            <v-list-item-content class="align-end">{{ item.name }} on {{ item.name }}</v-list-item-content>
                          </v-list-item>
                          <v-list-item>
                            <v-list-item-content>Shares:</v-list-item-content>
                            <v-list-item-content class="align-end">{{ item.shares }} on {{ item.purchase_date }}</v-list-item-content>
                          </v-list-item>
                        </v-list>
                      </v-card>
                    </v-col>
